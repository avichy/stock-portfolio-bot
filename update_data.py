...
if should_update:
    ...
    try:
        ...
        for ticker in all_strategy_tickers:
            ...
            # תמיכה בכל וריאציות השמות האפשריות לשלב 4 (Long & Swing)
            for prefix in [
                f"{ticker}_LONG",
                f"{ticker}_SWING",
                ticker,
        ...
        # מילוי דינמי לתיק האישי בסעיף 5 (פרוט פוזיציה והרצינול המלא)
        ...
        # מילוי דינמי לחדשות ומעקב מניות (שלב 8)
        for ticker in all_strategy_tickers:
