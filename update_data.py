...
SW_STOCKS_META = [
    ...
    },
    {
        ...
        "news": (
            'תנועות מחיר חדות סביב השקות מוצרים ודו"חות רבעוניים בסקטור'
            " השבבים."
        ),
        "why_invest": (
    ...
    },
    {
        ...
        "news": (
            "נפחי מסחר גבוהים מאוד ומומנטום חיובי המושך סוחרים לטווח הקצר והבינוני."
        ),
        "why_invest": (
    ...
    },
    {
        ...
        "news": (
            "תנועות מחיר חסונות וביקושים יציבים למוצרי הדגל סביב השקות"
            " ואקוסיסטם."
        ),
        "why_invest": (
  ...
  try:
    ...
    if (
      ...
      if bizportal_headlines:
        il_lines = [
            f"• {h['title']} (מקור: Bizportal)" for h in bizportal_headlines[:3]
        ]
        il_news_text = (
            "<br>".join(il_lines)
            + "<br>לסיכום: השוק המקומי מושפע ישירות מהתפתחויות גיאופוליטיות ומדדי"
            " המאקרו."
        )
      else:
        il_news_text = (
