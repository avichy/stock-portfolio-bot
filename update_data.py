...
if __name__ == "__main__":
    try:
        ...
        ai_insights = fetch_ai_insights_from_gemini(base_market_data, portfolio_buys, date_str, day_name)
        ...
        if OUTPUT_FILE in status.stdout or PORTFOLIO_FILE in status.stdout or AI_CACHE_FILE in status.stdout:
            subprocess.run(["git", "commit", "-m", f"Update site, portfolio and daily cross-sector AI insights on {day_name}"], check=True)
