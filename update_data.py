...
def fetch_us_market_news():
  """שליפת חדשות שוק אמריקאי וגיאופוליטי מ-Google News RSS"""
  try:
    query = (
    ...
    for a_tag in soup.find_all("a", href=True):
      ...
      if len(text) > 25 and text not in seen_titles:
        if not any(
          ...
          news_items.append(
              {"title": text, "link": link, "source": "Bizportal"}
          )
...
def format_text_with_conclusion(text, prefix_num=None):
  ...
  return (
      ...
      f' mt-1 mb-3" dir="rtl" style="text-align:'
      f' right;">{formatted_content}</span>'
  )
...
def format_news_description(text):
  ...
  cleaned = re.sub(
      r"^(?:סיכום הכתבה:?|לסיכום:?)\s*[:\-]?\s*", "", cleaned, flags=re.IGNORECASE
  ).strip()
...
def format_analyst_text(text):
  if not text or not str(text).strip() or str(text).strip() in ["''", '""']:
    text = (
        "אין נתונים עדכניים זמינים כרגע מסקירת האנליסטים. לסיכום: מומלץ להמתין"
        " לעדכונים נוספים בשווקים."
    )
  if "לסיכום" not in str(text):
    text = (
        str(text).strip() + " לסיכום: מומלץ לעקוב אחר התפתחות המגמות בשווקים."
    )
...
LT_STOCKS_META = [
    {
        ...
        "why_invest": (
            "מובילה גלובלית עם תזרים מזומנים אדיר וביקושים קשיחים לשירותי ענן"
            " ובינה מלאכותית."
        ),
    },
    {
        ...
        "why_invest": (
            "ניהול פיננסי מעולה ומאזן חסון המייצרים תשואות עקביות בכל מצב שוק."
        ),
    },
    {
        "ticker": "JNJ",
        ...
        "why_invest": (
            "חברה דפנסיבית מובהקת עם פורטפוליו רפואי רחב והיסטוריית דיבידנדים"
            " מרשימה."
        ),
    },
    {
        ...
        "why_invest": (
            "יעילות תפעולית גבוהה ותגמול נדיב למשקיעים באמצעות דיבידנדים ורכישות"
            " עצמיות."
        ),
    },
    {
        ...
        "why_invest": (
            "חסינות אינפלציונית מוכחת ונוכחות אלקטרונית מתרחב המבטיחים צמיחה"
            " יציבה."
        ),
    },
    {
        ...
        "why_invest": (
            "שליטה מוחלטת בענן ובמסחר המקוון עם צמיחה מואצת בשולי הרווח."
        ),
    },
    {
        "ticker": "UNH",
        ...
        "news": (
            "צמיחה עקבית במספר המבוטחים וביקוש קשיח לשירותי בריאות וניהול סיכונים"
            " רפואיים."
        ),
        "why_invest": (
            "מודל עסקי עמיד המבוסס על ביקושים קשיחים במגזר הבריאות הצומח."
        ),
    },
    {
        "ticker": "PG",
        ...
        "news": (
            "כוח תמחור חזק אל מול אינפלציה ומותגים גלובליים חזקים המבטיחים יציבות."
        ),
        "why_invest": (
            "מותגים מובילים המאפשרים שמירה על רווחיות גבוהה גם בתקופות"
            " אינפלציוניות."
        ),
    },
    {
        ...
        "why_invest": (
            "משמעת פיננסית קפדנית ותשואת דיבידנד גבוהה המגנים על תיק ההשקעות."
        ),
    },
    {
        "ticker": "BRK-B",
        ...
        "news": (
            "נזילות עצומה ופורטפוליו מבוזר של עסקים ראשיים המעניקים ביטחון למשקיע"
            " ארוך טווח."
        ),
        "why_invest": (
            "ניהול מופתי וביזור עמוק בכלכלה האמריקאית המקנים הגנה מעולה לירידות."
        ),
    },
]
...
SW_STOCKS_META = [
    {
        ...
        "news": (
            "תנודתיות גבוהה המייצרת הזדמנויות מסחר יומי וסווינג עם מומנטום"
            " חזק."
        ),
        "why_invest": (
            "תנועות מחיר חדות המייצרות פוטנציאל רווח מהיר לסוחרים יומיים וסווינג."
        ),
    },
    {
        "ticker": "AMD",
        ...
        "why_invest": (
            "חשיפה ישירה לשוק השבבים וה-AI המייצרת מומנטום מסחר אטרקטיבי."
        ),
    },
    {
        "ticker": "COIN",
        ...
        "why_invest": (
            "תנודתיות גבוהה המונעת מנכסים דיגיטליים ומייצרת הזדמנויות רווח מהירות."
        ),
    },
    {
        "ticker": "OXY",
        ...
        "news": (
            "מעקב צמוד אחר מחירי הסחורות והאנרגיה המייצרים מהלכים מהירים במסחר."
        ),
        "why_invest": (
            "גיבוי מוסדי חזק ורגישות למחירי האנרגיה היוצרים מהלכי מסחר ברורים."
        ),
    },
    {
        "ticker": "PLTR",
        ...
        "why_invest": (
            "מומנטום טכנולוגי אדיר וביקושים מוסדיים חזקים למערכות ה-AI שלה."
        ),
    },
    {
        "ticker": "NVO",
        ...
        "why_invest": (
            "מובילות בלעדית בתרופות הרזיה וביקושים גלובליים עצומים המרימים את"
            " המניה."
        ),
    },
    {
        ...
        "why_invest": (
            "תמחור אטרקטיבי ומהלכי טิร์ן-אראונד טכניים התומכים במומנטום עולה."
        ),
    },
    {
        "ticker": "BA",
        ...
        "why_invest": (
            "פוטנציאל התאוששות חזק מאירועים תפעוליים המייצר הזדמנויות סווינג"
            " רווחיות."
        ),
    },
    {
        ...
        "why_invest": (
            "כלי גידור מעולה לשוק המניות המציע תנועות מחיר מהירות סביב הזהב."
        ),
    },
    {
        "ticker": "AAPL",
        ...
        "news": (
            "תנועות מחיר חסונות וביקושים יציבים למוצרי הדגל סביב השקות ואקוסיסטם."
        ),
        "why_invest": (
            "מומנטום מסחר חזק ובסיס נרחב המייצרים תנועות סווינג צפויות ואמינות."
        ),
    },
]
  ...
  for ticker in tickers:
    ...
    if data and data["price"] > 0:
      ...
      market_data[ticker] = defaults.get(
          ticker,
          {"price": 100.0, "change": 0.0, "target": 0.0, "pre_market": 100.0},
      )
  return market_data
...
if __name__ == "__main__":
  try:
    ...
    bizportal_headlines_text = (
        "\n".join([
            f"- Title: {h['title']} | Source: {h.get('source', 'Bizportal')} |"
            f" Link: {h['link']}"
    ...
    if (
      ...
      if safe_us_headlines:
        us_lines = [
            f"• <a href='{h['link']}' target='_blank'"
            f" class='text-cyan-400 hover:underline'>{h['title']}</a> (מקור:"
            " Google News RSS)"
            for h in safe_us_headlines
        ]
        us_news_text = (
    ...
    if (
      ...
      if safe_il_headlines:
        ...
        il_news_text = (
            "<br>".join(il_lines)
            + "<br>לסיכום: השוק המקומי מושפע ישירות מהתפתחויות כלכליות"
            " מקומיות."
        )
      else:
        il_news_text = (
